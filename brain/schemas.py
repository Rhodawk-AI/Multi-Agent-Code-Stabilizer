...
class SoftwareAccomplishmentSummary(BaseModel):
    ...
    advisory_disclaimer: str = (
        "ADVISORY ONLY: Generated by Rhodawk AI (unqualified tool — no TQD per DO-330). "
        "All outputs require independent human verification before citation as certification evidence."
    )
